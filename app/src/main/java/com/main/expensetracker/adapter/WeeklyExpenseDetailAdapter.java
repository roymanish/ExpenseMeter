 ...
 *
 */
public class WeeklyExpenseDetailAdapter extends ArrayAdapter<ExpenseData>{
	...
	public WeeklyExpenseDetailAdapter(Context context, ArrayList<ExpenseData> smsDataList) {
	...
	public void onActivityResult(int requestCode, Intent data){
		...
		{  
			...
			updateExpenseDetailsRecord(editAmount, editDate, editCategory, position);
	...
	public void updateExpenseDetailsRecord(String amount, String date, String expenseCategory, int pos){

		ExpenseData data = getSmsList().get(pos);
		data.setAmount(amount);
		data.setDate(date);
		data.setCategory(expenseCategory);
		ExpenseDataProcessor.getInstance().updateWeeklyDataInFile(getSmsList(), context);
